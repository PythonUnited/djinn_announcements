...
from forms.announcement import AnnouncementEditForm, AnnouncementAddForm
...
_urlpatterns = patterns(
    ...
    url(r"^add/announcement/?$",
        CreateView.as_view(model=Announcement, form_class=AnnouncementAddForm),
        name="djinn_announcements_add_announcement"),

    url(r"^edit/announcement/(?P<pk>[\d]+)/?$",
        UpdateView.as_view(model=Announcement, form_class=AnnouncementEditForm),
